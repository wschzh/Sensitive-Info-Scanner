...
var all = compileAll([]Pattern{
	...
	},
	{
		Name:        "银行卡号",
		Level:       types.High,
		Pattern:     `\b(?:62\d{14,17}|4\d{12}(?:\d{3}){0,2}|5[1-5]\d{14}|3[47]\d{13}|3\d{13}|6(?:011|5\d{2})\d{12})\b`,
		Description: "银行卡号（优先覆盖国内银联，命中后执行 Luhn 校验）",
		Examples:    []string{"6222020000000007", "4111111111111111"},
		MinDigits:   13,
	},
	{
		Name:        "密码",
